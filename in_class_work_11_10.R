...
# Using the plot() function and our second model which is svm_model3, we can plot the results
# here the axes are  Petal.Width Vs Petal.Length
plot(svm_model3, data = iris, Petal.Width~Petal.Length, slice = list(Sepal.Width = 3, Sepal.Length = 4))

# Prediction using the second model (svm_model3) we created on the iris dataset.
